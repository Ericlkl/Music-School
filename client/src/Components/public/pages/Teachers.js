...
//         <div className='description'>This is the description box.</div>
//       </div>

//       <div className='extra content'>
//         <span className='right floated'>1 Years+ Experiences</span>
//         <span>
...
const Teachers = () => {
  ...
  return (
    <PageFrame
      heroImg={bg_img}
      heroTitle='Teachers'
      heroSubtitle='Professional Teachers in Australia'
    >
